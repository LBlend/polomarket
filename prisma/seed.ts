...
async function main() {
  ...
  const waypoints = [
    ...
    { name: "Junktown, Pargue", lat: 50.05875, lng: 14.011, order: 3, visited: false },
    ...
    { name: "Metallurgov Palace of Culture, Oksemen", lat: 49.974115, lng: 82.590248, order: 25, visited: false },
  ];

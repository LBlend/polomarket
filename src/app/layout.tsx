...
export const metadata: Metadata = {
  ...
  description:
    "Follow 4 fat dudes driving from Oslo to Oskemen in the Mongol Rally 2026 in their Tjukk Tuk. Live tracking and betting on events, all for covering our costs and charity.",
  icons: {
    icon: "/logo.svg",
    shortcut: "/logo.svg",
    apple: "/logo.svg",
        ...
        <Providers>
          ...
          <footer className="border-t border-rally-border bg-rally-dark py-10 px-4">
            <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-neutral-600">
              <span className="font-display tracking-widest text-gold-700">
                TEAM POLOMARKET
              </span>
              <span>
                Mongol Rally 2026 | Oslo → <s>Ulaanbaatar</s> Oskemen
              </span>
            </div>
          </footer>
        </Providers>
